...
class Configuration:
    ...
    def __init__(self,
        ...
        try:
            ...
            self.traning_pipeline_config = self.get_trainig_pipeline_config()
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            ingested_test_dir = os.path.join(data_ingestion_info, 
    ...
    def get_trainig_pipeline_config(self) -> TrainigPippelineConfig:
        try:
            training_pipeline_config = self.config_info[TRAINIG_PIPELINE_CONFIG_KEY]
            artifact_dir = os.path.join(ROOT_DIR, 
                                        training_pipeline_config[TRAINIG_PIPELINE_NAME_KEY],
                                        training_pipeline_config[TRAINIG_PIPELINE_ARTIFACT_DIR_KEY])

            traning_pipeline_config = TrainigPippelineConfig(artifact_dir=artifact_dir)
